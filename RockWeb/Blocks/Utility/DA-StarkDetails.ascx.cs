...
namespace RockWeb.Plugins.org_rocksolidchurch.Tutorials
{
    ...
    public partial class Task1Details : Rock.Web.UI.RockBlock
    {
        ...
        private void ShowGroupDetails(int? GroupId)
        {
            ...
            if (group == null)
            {
                Name.Text = "Can't Find Group";
                return;
            }
            Name.Text = group.Name;
            Description.Text = group.Description;
            DateCreated.Text = group.CreatedDateTime.HasValue ? group.CreatedDateTime.ToString() : "N/A";
            DateModified.Text = group.ModifiedDateTime.HasValue ? group.ModifiedDateTime.ToString() : "N/A";
            GroupCapacity.Text = group.GroupCapacity.HasValue ? group.GroupCapacity.ToString() : "No Max Capacity";
        }
